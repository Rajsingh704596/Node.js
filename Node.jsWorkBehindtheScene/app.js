...
//* Synchronous-  Task are executed sequentially, Each task blocks the next until completed.
//* Asynchronous-  Task don't block execution. Uses callbacks, promises, async/await
...
//# V8 engine- Google's high-performance JavaScript engine that ' compiles JavaScript into machine code.'  (Handle Synchronous Operation)

//# Libuv - it is C library that provide Node.js with cross-platform support for asynchronous I/O operations, file system, networking, and more. Includes the "event loop" and "thread pool", enabling non-blocking tasks like file reading, networking, and timers. (handle Asynchronous operation)
