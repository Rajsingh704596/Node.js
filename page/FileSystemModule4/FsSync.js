//! fs(file system) module in Node.js is a core module that allows "to work with the file system, enabling you to read, write, update, delete, and watch files".
...
// const fileName="test.txt";
// const filePath= path.join(__dirname, fileName);        //it's make sure particular folder path m ye fileName join ho ja ye
...
//? options: (Optional) Encoding ('utf-8') to get data as a string. (kis formate m data read kana hai)
...
// console.log(appendFile);                // test.txt file m data add hoke update ho ja ye ga
