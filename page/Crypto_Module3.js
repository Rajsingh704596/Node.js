//! Crypto Module in Node.js- (inbuilt)
...
//$ 1. crypto.randomBytes(size)-
   ...
   // const randomValue = crypto.randomBytes(8);           //@Note- The size must not be larger than 2**31 - 1.
    ...
    console.log(randomValue);                  //o/p- 45cca6a2fbfb7841  (8*2=16 digit and every digit is form of hexadecimal(0-f))            

//$ 2. crypto.createHash(algorithm)-
    //^ Purpose- Creates a hash for a given input using algorithm like sha2 56.(most probably used) {others algo- SHA-1, SHA-224, SHA-256, SHA-384, SHA-512, SHA-3, MD5, MD4, MD2, RIPEMD-128, RIPEMD-160, RIPEMD-256, RIPEMD-320, BLAKE2, BLAKE3, WHirlpool, Tiger}
...
//# It's alternative of bcrypt(third party library),but crypt.createHash is inbuilt library   
   ...
   //@ but this output we can't store in data , we pass 3 things -1. kis algo k through hash kar na hai  2. update value m kis data ko change kar na hai wo value pass kar-ege  3. digest m value pass kar-ege jis formate me data ko pass kar-na hai like hex for getting data in hexadecimal format
